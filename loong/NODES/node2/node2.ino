...
#define DEVICE_NAME   "node2"
#define DEVICE_SECRET "26dfb3ee8f2a4d381dd32f42ec9009a8"
...
{
  AliyunIoTSDK::send((char*)"temperature2",    temp.ahtValues.temperature);
  AliyunIoTSDK::send((char*)"humidity2",       temp.ahtValues.humidity);
  AliyunIoTSDK::send((char*)"pressure2",       temp.ahtValues.pressure);
  AliyunIoTSDK::send((char*)"mokescope2",      temp.mq2Values.smokescope);
  AliyunIoTSDK::send((char*)"battery2",        temp.batValues.battery);
}
