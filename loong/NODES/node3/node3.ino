 ...
 */
// WIFI
#define WIFI_SSID     "apple"
#define WIFI_PASSWD   "1037284629"
static WiFiClient espClient;

// Aliyun-IoT
#define PRODUCT_KEY   "jk3pVO4Uxky"
#define DEVICE_NAME   "node3"
#define DEVICE_SECRET "d23cee81f1d40b87d573add6da1aa6e8"
...
{
  AliyunIoTSDK::send((char*)"temperature3",    temp.ahtValues.temperature);
  AliyunIoTSDK::send((char*)"humidity3",       temp.ahtValues.humidity);
  AliyunIoTSDK::send((char*)"pressure3",       temp.ahtValues.pressure);
  AliyunIoTSDK::send((char*)"smokescope3",      temp.mq2Values.smokescope);
  AliyunIoTSDK::send((char*)"battery3",        temp.batValues.battery);
}
